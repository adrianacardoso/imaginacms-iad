...
class AdUpApiController extends BaseApiController
{
  private $ad;
  private $field;

  public function __construct(AdUpRepository $ad, FieldController $field)
  {
    parent::__construct();
    $this->ad = $ad;
    $this->field = $field;
  ...
  public function index(Request $request)
  {
    try {
      ...
      //Response
      $response = [
        "data" => AdUpTransformer::collection($dataEntity)
      ];
  ...
  public function show($criteria, Request $request)
  {
    try {
      ...
      //Response
      $response = ["data" => new AdUpTransformer($dataEntity)];
  ...
  public function create(Request $request)
  {
    ...
    try {
      ...
      //Validate Request
      $this->validateRequestApi(new CreateAdUpRequest((array)$data));
  ...
  public function update($criteria, Request $request)
  {
    ...
    try {
      ...
      $params = $this->getParamsRequest($request);
      //Validate Request
      $this->validateRequestApi(new UpdateAdUpRequest((array)$data));
